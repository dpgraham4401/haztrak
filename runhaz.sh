...
generate_api_schema() {
    ...
    exec_cmd="$base_py_cmd spectacular --settings haztrak.settings.prod --file $base_dir/docs/api/postman/schemas/openapi-schema.yaml"
    eval "$exec_cmd"
    exit
}
