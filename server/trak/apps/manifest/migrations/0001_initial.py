...
import trak.apps.manifest.models.contact
import trak.apps.manifest.models.manifest
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        ...
                        null=True,
                        validators=[trak.apps.manifest.models.manifest.validate_mtn],
                    ),
                ),
                (
                    "new_destination",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("number", trak.apps.manifest.models.contact.ManifestPhoneNumber(max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "mtn",
                    models.CharField(
                        default=trak.apps.manifest.models.manifest.draft_mtn,
                        max_length=30,
                        unique=True,
                        validators=[trak.apps.manifest.models.manifest.validate_mtn],
