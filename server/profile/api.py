...
def list_profiles(request: HttpRequest) -> QuerySet[Profile]:
    """List all profiles."""
    return Profile.objects.all()


@router.get("/profile/me", response=ProfileSchema)
def get_my_profile(request: HttpRequest) -> Profile:
...
def get_profile(request: HttpRequest, user_id: str) -> Profile:
...
def get_my_rcrainfo_profile(request: HttpRequest) -> RcrainfoProfile:
...
def get_rcrainfo_profile(request: HttpRequest, user_id: str) -> RcrainfoProfile:
