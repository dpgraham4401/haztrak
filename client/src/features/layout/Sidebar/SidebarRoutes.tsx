  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        text: 'RCRAInfo',
        url: process.env.DEV ? 'https://rcrainfopreprod.epa.gov' : 'https://rcrainfo.epa.gov',
  ...
  },
  {
    ...
    routes: [
      ...
      },
      {
        ...
        icon: LuFileCode2,
        text: 'OpenAPI Docs',
        url: `${process.env.NEXT_PUBLIC_HT_API_URL}/api/schema/swagger-ui`,
      ...
      },
      {
        ...
        url: `${process.env.NEXT_PUBLIC_GITHUB_URL}/issues`,
        description: 'API Documentation',
        external: true,
      },
    ],
